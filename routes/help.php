...
?>
  <section class="panel help-panel" style="margin:1.5rem 0;padding-top:1.5rem;padding-bottom:1.5rem;">
    ...
    <p>Forgot to log a dose from an earlier day, or taking something as-needed? Use <strong>Log dose now</strong> from the medication&rsquo;s actions menu. If the medication has multiple scheduled times, a slot picker lets you choose which one, and asks whether it was on time or late (with a custom time field). PRN or interval medications without fixed slots get a simpler &ldquo;what time did you take it&rdquo; prompt instead. Tapping Take after the grace period has already passed opens a similar prompt so you can record the actual time, along with feedback and notes.</p>
    ...
    <p>If logging a dose would bring your supply down to zero, a prompt lets you <strong>Adjust quantity</strong>, jump straight to <strong>Log a refill</strong>, dismiss with <strong>Not now</strong>, or <strong>Cancel this dose</strong> entirely (which fully undoes the dose log and restores your inventory, as if it was never marked taken).</p>
